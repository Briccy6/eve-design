...
<?php
	...
	if(isset($ecat_ids)) {
		...
		for($i=0;$i<count($p_ids);$i++) {
			...
			// Getting featured photo to unlink from folder, but check if it exists first
			...
			// Getting other photos to unlink from folder, but check if they exist first
			...
			// Delete from tbl_order first to avoid foreign key issues
			...
			// Delete from tbl_payment (related to tbl_order)
